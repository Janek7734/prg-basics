...
def add_product(file_name, product_name):
   with open(file_name, 'a') as file:  # Open file in append mode
      file.write(product_name + '\n')  # Write the product name followed by a newline
...
while product != "0":
   ...
   if product == '0':
      print("Shopping list creation stopped.")  # Notify when the loop stops
   else:
      add_product(shopping_list, product)  # Add the product to the shopping list file
